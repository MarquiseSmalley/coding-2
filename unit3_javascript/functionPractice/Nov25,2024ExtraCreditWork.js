...
"Functions are a group of components which perform a specific task."
...
calculate()
// 3. Please create a function that will accept a name as a string and contatonate that string in a message that welcomes the person to coding class by name. Then return the result using the print() or console.log function.
...
"Step 1: White bread"
"Step 2: Apply cheese"
"Step 3: Place on ground beef"
"Step 4: Toast the cheese and meat inside the bread"
// 6. Please explain what the difference is between a function call and a function definition?
" A function is a block of code that performs a specific task and while a function call is an expression that invokes a function and executes the code in the function."