...
1. "FROZEN FOOD ISLE :"
frozen_foods= [ " Frozen pizza" , "Ice cream", " Frozen vegetables", " Frozen chickn nuggets", "Frozen waffles"]

2. ' INTERNATIONAL FOOD ISLE'
International_foods = ["Sushi rice" , " Taco Shells" , "Curry paste" , "Soy Sauce" , "Sriracha sauce"]

3. "PRODUCE ISLE"
Fresh_Produce = ["Banana" , "Spinach" , " Tomato ", "Carrots" , "Avocados"]
...
Print(number[2]);  # Third Item: 39
Print(number[4]);  # Fifth Item: 293
